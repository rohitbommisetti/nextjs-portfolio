...
var SandpackClient = function() {
     ...
     */ SandpackClient.prototype.updateOptions = function(options) {
        if (!__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$dequal$2f$dist$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["dequal"](this.options, options)) {
            this.options = options;
            this.updateSandbox();
        }
    };
 ...
 */ var findStartScriptPackageJson = function(packageJson) {
    ...
    try {
        ...
        throw __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"]("Could not parse package.json file: " + e.message);
    }
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$outvariant$2f$lib$2f$index$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["invariant"](scripts, "Failed to start. Please provide a `start` or `dev` script on the package.json");
    ...
    throw __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"]("Failed to start. Please provide a `start` or `dev` script on the package.json");
};
var getMessageFromError = function(error) {
    ...
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"]("The server could not be reached. Make sure that the node script is running and that a port has been started.");
};
...
function loadPreviewIframe(iframe, url) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["_"](this, void 0, void 0, function() {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a"](this, function(_a) {
            contentWindow = iframe.contentWindow;
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["n"](contentWindow, "Failed to await preview iframe: no content window found");
            TIME_OUT = 90000;
            MAX_MANY_TIRES = 20;
            tries = 0;
            return [
                ...
                new Promise(function(resolve, reject) {
                    var triesToSetUrl = function() {
                        ...
                        if (tries >= MAX_MANY_TIRES) {
                            reject(__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"]("Could not able to connect to preview."));
                            return;
                        }
...
/* eslint-disable no-console,@typescript-eslint/no-explicit-any,prefer-rest-params,@typescript-eslint/explicit-module-boundary-types */ var SandpackNode = function(_super) {
    __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["g"](SandpackNode, _super);
    function SandpackNode(selector, sandboxInfo, options) {
        if (options === void 0) {
            options = {};
        }
        var _this = _super.call(this, selector, sandboxInfo, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["h"](__TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["h"]({}, options), {
            bundlerURL: options.bundlerURL
        })) || this;
        _this._modulesCache = new Map();
        _this.messageChannelId = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$consoleHook$2d$cdbe54ab$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["g"]();
                ...
                switch(_a.label){
                    ...
                    case 5:
                        ...
                        this.dispatch({
                            ...
                            title: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$consoleHook$2d$cdbe54ab$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a"](err_1)
                        });
                        this.dispatch({
                            type: "done",
     ...
     */ SandpackNode.prototype.createShellProcessFromTask = function(files) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["_"](this, void 0, void 0, function() {
            ...
            var _a;
            var _this = this;
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a"](this, function(_b) {
                switch(_b.label){
                    case 0:
                        packageJsonContent = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$consoleHook$2d$cdbe54ab$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["r"](files["/package.json"]);
                        this.emulatorCommand = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$consoleHook$2d$cdbe54ab$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["b"](packageJsonContent);
                        ...
                        return [
                            ...
                            this.emulatorShellProcess.on("exit", function(exitCode) {
                                _this.dispatch({
                                    ...
                                    action: "notification",
                                    notificationType: "error",
                                    title: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["c"]("Error: process.exit(".concat(exitCode, ") called."))
                                });
                            })
                        ];
                    case 1:
     ...
     */ SandpackNode.prototype.manageIframes = function(selector) {
         ...
         */ if (typeof selector === "string") {
            ...
            __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["n"](element, "The element '".concat(selector, "' was not found"));
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["n"](this.iframe.parentNode, "The given iframe does not have a parent.");
        /**
                    ...
                    case 0:
                        ...
                        return [
                            ...
                            this.emulator.fs.watch([
                                ...
                                return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["_"](_this, void 0, void 0, function() {
                                    ...
                                    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a"](this, function(_b) {
                                        switch(_b.label){
                                            ...
                                            case 4:
                                                ...
                                                this._modulesCache.set(event.path, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$consoleHook$2d$cdbe54ab$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["w"](content));
                                                return [
                                                    3 /*break*/ ,
                                                    9
                                                ];
                                            ...
                                            case 7:
                                                ...
                                                this._modulesCache.set(event.newPath, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$consoleHook$2d$cdbe54ab$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["w"](newContent));
                                                return [
                                                    3 /*break*/ ,
                                                    9
                                                ];
                                            ...
                                            case 10:
                                                ...
                                                this.dispatch({
                                                    ...
                                                    action: "notification",
                                                    notificationType: "error",
                                                    title: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$consoleHook$2d$cdbe54ab$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a"](err_2)
                                                });
                                                return [
                                                    3 /*break*/ ,
                                                    11
    ...
    SandpackNode.prototype.updateSandbox = function(setup) {
        var _this = this;
        var _a;
        var modules = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$consoleHook$2d$cdbe54ab$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["f"](setup.files);
        /**
         * Update file changes
         */ if (((_a = this.emulatorShellProcess) === null || _a === void 0 ? void 0 : _a.state) === "running") {
            Object.entries(modules).forEach(function(_a) {
                var key = _a[0], value = _a[1];
                if (!_this._modulesCache.get(key) || __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$consoleHook$2d$cdbe54ab$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["r"](value) !== __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$consoleHook$2d$cdbe54ab$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["r"](_this._modulesCache.get(key))) {
         ...
         */ Object.entries(modules).forEach(function(_a) {
            var key = _a[0], value = _a[1];
            _this._modulesCache.set(key, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$consoleHook$2d$cdbe54ab$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["w"](value));
        });
    };
    SandpackNode.prototype.dispatch = function(message) {
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["_"](this, void 0, void 0, function() {
            var _c;
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codesandbox$2f$sandpack$2d$client$2f$dist$2f$types$2d$0877c553$2e$mjs__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["a"](this, function(_d) {
                switch(_d.label){
                    case 0:
                        _c = message.type;
                        switch(_c){
...
//# sourceMappingURL=node_modules_@codesandbox_bb7284._.js.map