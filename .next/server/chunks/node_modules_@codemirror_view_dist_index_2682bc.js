...
function moveVisually(line, order, dir, start, forward) {
    ...
    let nextIndex = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["findClusterBreak"](line.text, startIndex, span.forward(forward, dir));
...
class DocView extends ContentView {
    ...
    coordsForChar(pos) {
        ...
        let end = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["findClusterBreak"](child.text, off);
...
function groupAt(state, pos, bias = 1) {
    ...
    if (bias < 0) from = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["findClusterBreak"](line.text, linePos, false);
    else to = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["findClusterBreak"](line.text, linePos);
    let cat = categorize(line.text.slice(from, to));
    while(from > 0){
        let prev = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["findClusterBreak"](line.text, from, false);
        if (categorize(line.text.slice(prev, from)) != cat) break;
        from = prev;
    }
    while(to < line.length){
        let next = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["findClusterBreak"](line.text, to);
...
function posAtCoordsImprecise(view, contentRect, block, x, y) {
    ...
    return block.from + __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["findColumn"](content, into, view.state.tabSize);
}
...
function runHandlers(map, event, view, scope) {
    let name = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$w3c$2d$keyname$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["keyName"](event);
    let charCode = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["codePointAt"](name, 0), isChar = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["codePointSize"](charCode) == name.length && name != " ";
...
const specialCharConfig = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Facet"].define({
    combine (configs) {
        let config = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["combineConfig"](configs, {
            render: null,
        ...
        makeDecorator(conf) {
            return new MatchDecorator({
                ...
                decoration: (m, view, pos)=>{
                    let { doc } = view.state;
                    let code = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["codePointAt"](m[0], 0);
                    if (code == 9) {
                        let line = doc.lineAt(pos);
                        let size = view.state.tabSize, col = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["countColumn"](line.text, size, pos - line.from);
                        return Decoration.replace({
...
function rectangleFor(state, a, b) {
    ...
    if (a.off > MaxOff || b.off > MaxOff || a.col < 0 || b.col < 0) {
        ...
        for(let i = startLine; i <= endLine; i++){
            let line = state.doc.line(i);
            let start = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["findColumn"](line.text, startCol, state.tabSize, true);
            if (start < 0) {
                ...
                let end = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["findColumn"](line.text, endCol, state.tabSize);
...
function getPos(view, event) {
    ...
    let col = off > MaxOff ? -1 : off == line.length ? absoluteColumn(view, event.clientX) : __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["countColumn"](line.text, view.state.tabSize, offset - line.from);
    return {
        line: line.number,
        col,
        off
...
const lineNumberConfig = /*@__PURE__*/ __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["Facet"].define({
    combine (values) {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$codemirror$2f$state$2f$dist$2f$index$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["combineConfig"](values, {
            formatNumber: String,
            domEventHandlers: {}
        }, {
...
//# sourceMappingURL=node_modules_@codemirror_view_dist_index_2682bc.js.map